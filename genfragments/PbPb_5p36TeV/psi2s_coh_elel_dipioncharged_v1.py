...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/cms/store/group/phys_heavyions/dyano/psi2s_gridpacks/psi2s_coh_elel_dipioncharged_v1.tar.gz'),
...
electrongenfilter = cms.EDFilter("MCParticlePairFilter",
...
ProductionFilterSequence = cms.Sequence(generator * electrongenfilter * piongenfilter)
